...
enum e_char_del_response {
	...
	CHAR_DELETE_PARTY,
	CHAR_DELETE_TIME,
	CHAR_DELETE_SECURITY_LOCK, ///< @security: char deletion denied by #ACCOUNTLOCK
};
...
struct Char_Config {
	...
	bool security_lock_block_delete;	///< @security: block char deletion when #ACCOUNTLOCK=1 (default: true)
};
