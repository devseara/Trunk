...
#define SCRIPT_CONSTANTS_HPP
	...
	export_constant2("bCriticalSkillDef",SP_CRITICAL_SKILL_DEF);
	...
	export_constant(SC_AUTOATTACKVIP_PENALTY);
	export_constant(SC_AUTOATTACK_PENALTY);
	export_constant(SC_VIP);
...
/// @APIHOOK_START(EFST_CONST)
	...
	export_constant(EFST_AUTOATTACKVIP_PENALTY);
	export_constant(EFST_AUTOATTACK_PENALTY);
	export_constant(EFST_VIP);
