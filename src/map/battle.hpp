...
struct Battle_Config
{
	...
	int32 drops_by_luk2;
	int32 overkill_mode;
	int32 drops_overkill;
	int32 aa_drops_penalty;
	int32 fake_drop_rate;
	int32 sell_price_threshold; 
    int32 sell_rate_below;     
    int32 sell_rate_above;
...
// eAthena additions
	...
	int32 feature_autoattack_drop_ratio;
	int32 feature_autoattack_exp_ratio;
	int32 feature_autoattack_allow_town;
	int32 feature_autoattack_allow_pvp;
	int32 feature_autoattack_allow_gvg;
	int32 feature_autoattack_allow_bg;
	int32 feature_autoattack_duration_type;
	int32 feature_autoattack_timer;
	int32 feature_autoattack_iplimit;
	int32 feature_autoattack_gepardlimit;
	int32 feature_autoattack_mobdead_delay;

	//fake players
	int32 feature_fake_enable;
	int32 fake_max_online;
	int32 fake_allow_teleport;
	int32 fake_teleport_min;
	int32 fake_teleport_max;
	int32 fake_waypoint_repath_ms;
	int32 fake_idle_sit_weight;
	int32 fake_idle_turn_weight;
	int32 fake_idle_move_weight;
	int32 fake_idle_step_min;
	int32 fake_idle_step_max;
	int32 fake_idle_action_min_ms;
	int32 fake_idle_action_max_ms;
	int32 fake_spawn_batch_min;
	int32 fake_spawn_batch_max;
	int32 fake_adjust_period_sec;
	int32 fake_reject_pm;
	int32 fake_loot_priority;
